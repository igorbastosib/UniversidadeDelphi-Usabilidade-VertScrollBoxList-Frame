...
uses
  ...
  FormInTabs.Mobile.View.FrameItemListModel in 'View\FormInTabs.Mobile.View.FrameItemListModel.pas' {FrameItemListModel: TFrame},
  FormInTabs.Mobile.View.Vendas.ItemList in 'View\Vendas\FormInTabs.Mobile.View.Vendas.ItemList.pas' {filVenda: TFrame};
